...
A Particle project named tcptest

## Welcome to your project!

Every new Particle project is composed of 3 important elements that you'll see have been created in your project directory for tcptest.
...
To flash through Cloud
`$ particle flash <device_id> <src folder>`
`$ particle flash <device_id> <file.bin>`
